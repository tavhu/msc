          ...
          <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <div class='input-group date'>
                            <input type='text' name="" id='' value='' class="form-control input-sm datepicker"/>
      ...
      <form role="form" >
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <label> <input type='radio' name='oneofsixteeenYN'  value='FullyIndependent' <?php  echo isset($servation_row->oneofsixteeenYN) ? ($servation_row->oneofsixteeenYN == 'FullyIndependent' ? 'checked' : '') : "";?>  > Fully Independent </label>                                       
              <label style='padding-left:25px;'> <input type='radio' name='oneofsixteeenYN' <?php echo isset($servation_row->oneofsixteeenYN) ?  ($servation_row->oneofsixteeenYN == 'PartiallyDependent' ? 'checked' : '') : "";?> value='PartiallyDependent'> Partially Dependent </label>
              <label style='padding-left:25px;'> <input type='radio' name='oneofsixteeenYN' <?php echo isset($servation_row->oneofsixteeenYN) ?  ($servation_row->oneofsixteeenYN == 'Fullydependent' ? 'checked' : '') : "";?> value='Fullydependent'> Fully dependent </label>   
            </div>
             <div class="form-group">
